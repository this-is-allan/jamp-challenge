    ...
    <div class="swiper-wrapper my-1">
      <div class="swiper-slide generic-card">
        <div class="generic-card__cover">
          <img src="https://static.ultrafarma.com.br/media/imagens_produtos/800px/00/700/90/9/00799448.jpg" alt="">
        </div>
    ...
    <div class="col-md-12">
      <div class="results-wrapper my-4">
        <h3 class="results-wrapper__title">
          Encontramos 8 produtos para a busca: <span class="text-highlight">Tylenol</span>
        </h3>
          ...
          <div class="row no-gutters">
            <div class="col-6 col-md-3 my-2">
              <div class="card card--product mx-1">
                <img class="card-img-top" src="https://static.ultrafarma.com.br/media/imagens_produtos/800px/00/700/90/9/00799448.jpg" alt="Card image cap">
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-primary py-3">Comparar preços</a>
                </div>
              </div>
            </div>
